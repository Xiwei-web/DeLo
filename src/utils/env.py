...
def get_hyper_parameters(cfg):
    ...
    # print("--- DEBUG: Inspecting 'cfg.train' object before access ---")
    # print(f"Type of cfg.train: {type(cfg.train)}")
    # print("Is 'BATCH_SIZE' in cfg.train? ", "BATCH_SIZE" in cfg.train)
    # print("Content of cfg.train:")
    # # 使用OmegaConf.to_yaml可以安全地打印出配置内容
    # print(OmegaConf.to_yaml(cfg.train))
    # print("--- DEBUG: Inspecting 'cfg' object's top level ---")
